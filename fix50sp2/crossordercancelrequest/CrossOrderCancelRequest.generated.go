...
func (m CrossOrderCancelRequest) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m CrossOrderCancelRequest) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m CrossOrderCancelRequest) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
