...
func (m QuoteResponse) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m QuoteResponse) SetValuationMethod(v enum.ValuationMethod) {
...
func (m QuoteResponse) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m QuoteResponse) SetOptPayoutType(v enum.OptPayoutType) {
...
func (m QuoteResponse) GetExDestination() (v string, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m QuoteResponse) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
