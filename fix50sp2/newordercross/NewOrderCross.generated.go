...
func (m NewOrderCross) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m NewOrderCross) SetValuationMethod(v enum.ValuationMethod) {
...
func (m NewOrderCross) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m NewOrderCross) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m NewOrderCross) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m NewOrderCross) GetExDestination() (v string, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m NewOrderCross) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m NewOrderCross) HasOptPayoutAmount() bool {
...
func (m NewOrderCross) HasValuationMethod() bool {
...
func (m NewOrderCross) HasNotionalPercentageOutstanding() bool {
...
func (m NewOrderCross) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m NewOrderCross) HasStrikePriceDeterminationMethod() bool {
...
func (m NewOrderCross) HasStrikePriceBoundaryMethod() bool {
...
func (m NewOrderCross) HasStrikePriceBoundaryPrecision() bool {
