...
func (m CollateralReport) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m CollateralReport) SetValuationMethod(v enum.ValuationMethod) {
...
func (m CollateralReport) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m CollateralReport) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m CollateralReport) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m CollateralReport) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m CollateralReport) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m CollateralReport) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m CollateralReport) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m CollateralReport) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m CollateralReport) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m CollateralReport) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m CollateralReport) HasOptPayoutAmount() bool {
...
func (m CollateralReport) HasValuationMethod() bool {
...
func (m CollateralReport) HasNotionalPercentageOutstanding() bool {
...
func (m CollateralReport) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m CollateralReport) HasStrikePriceDeterminationMethod() bool {
...
func (m CollateralReport) HasStrikePriceBoundaryMethod() bool {
...
func (m CollateralReport) HasStrikePriceBoundaryPrecision() bool {
