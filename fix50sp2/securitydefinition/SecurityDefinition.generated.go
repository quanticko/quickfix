...
func (m SecurityDefinition) SetTransactTime(v time.Time) {
...
func (m SecurityDefinition) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m SecurityDefinition) SetValuationMethod(v enum.ValuationMethod) {
...
func (m SecurityDefinition) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m SecurityDefinition) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m SecurityDefinition) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m SecurityDefinition) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m SecurityDefinition) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m SecurityDefinition) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m SecurityDefinition) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m SecurityDefinition) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m SecurityDefinition) GetTransactTime() (v time.Time, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m SecurityDefinition) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m SecurityDefinition) HasTransactTime() bool {
...
func (m SecurityDefinition) HasOptPayoutAmount() bool {
...
func (m SecurityDefinition) HasValuationMethod() bool {
...
func (m SecurityDefinition) HasNotionalPercentageOutstanding() bool {
...
func (m SecurityDefinition) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m SecurityDefinition) HasStrikePriceDeterminationMethod() bool {
...
func (m SecurityDefinition) HasStrikePriceBoundaryMethod() bool {
...
func (m SecurityDefinition) HasStrikePriceBoundaryPrecision() bool {
