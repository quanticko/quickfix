...
func (m AssignmentReport) SetInstrRegistry(v string) {
...
func (m AssignmentReport) SetPosReqID(v string) {
...
func (m AssignmentReport) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m AssignmentReport) SetValuationMethod(v enum.ValuationMethod) {
...
func (m AssignmentReport) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m AssignmentReport) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m AssignmentReport) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m AssignmentReport) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m AssignmentReport) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m AssignmentReport) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m AssignmentReport) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m AssignmentReport) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m AssignmentReport) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetPosReqID() (v string, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m AssignmentReport) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m AssignmentReport) HasPosReqID() bool {
...
func (m AssignmentReport) HasOptPayoutAmount() bool {
...
func (m AssignmentReport) HasValuationMethod() bool {
...
func (m AssignmentReport) HasNotionalPercentageOutstanding() bool {
...
func (m AssignmentReport) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m AssignmentReport) HasStrikePriceDeterminationMethod() bool {
...
func (m AssignmentReport) HasStrikePriceBoundaryMethod() bool {
...
func (m AssignmentReport) HasStrikePriceBoundaryPrecision() bool {
