...
func (m NewOrderSingle) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m NewOrderSingle) SetValuationMethod(v enum.ValuationMethod) {
...
func (m NewOrderSingle) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m NewOrderSingle) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m NewOrderSingle) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m NewOrderSingle) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m NewOrderSingle) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m NewOrderSingle) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m NewOrderSingle) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m NewOrderSingle) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m NewOrderSingle) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m NewOrderSingle) HasOptPayoutAmount() bool {
...
func (m NewOrderSingle) HasValuationMethod() bool {
...
func (m NewOrderSingle) HasNotionalPercentageOutstanding() bool {
...
func (m NewOrderSingle) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m NewOrderSingle) HasStrikePriceDeterminationMethod() bool {
...
func (m NewOrderSingle) HasStrikePriceBoundaryMethod() bool {
...
func (m NewOrderSingle) HasStrikePriceBoundaryPrecision() bool {
