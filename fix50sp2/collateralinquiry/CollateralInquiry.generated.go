...
func (m CollateralInquiry) SetValuationMethod(v enum.ValuationMethod) {
...
func (m CollateralInquiry) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m CollateralInquiry) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m CollateralInquiry) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m CollateralInquiry) SetSeniority(v enum.Seniority) {
...
func (m CollateralInquiry) SetStrikePriceDeterminationMethod(v enum.StrikePriceDeterminationMethod) {
	m.Set(field.NewStrikePriceDeterminationMethod(v))
}

//SetStrikePriceBoundaryMethod sets StrikePriceBoundaryMethod, Tag 1479
func (m CollateralInquiry) SetStrikePriceBoundaryMethod(v enum.StrikePriceBoundaryMethod) {
...
func (m CollateralInquiry) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m CollateralInquiry) SetOptPayoutType(v enum.OptPayoutType) {
...
func (m CollateralInquiry) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralInquiry) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
