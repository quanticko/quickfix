...
func (m CollateralInquiryAck) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralInquiryAck) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
