...
func (m StreamAssignmentRequest) SetStreamAsgnReqType(v enum.StreamAsgnReqType) {
...
func (m StreamAssignmentRequest) GetStreamAsgnReqID() (v string, err quickfix.MessageRejectError) {
...
func (m StreamAssignmentRequest) GetStreamAsgnReqType() (v enum.StreamAsgnReqType, err quickfix.MessageRejectError) {
