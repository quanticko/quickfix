...
func (m Quote) SetSettlCurrency(v string) {
...
func (m Quote) SetOrderRestrictions(v enum.OrderRestrictions) {
...
func (m Quote) SetBookingType(v enum.BookingType) {
...
func (m Quote) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m Quote) SetValuationMethod(v enum.ValuationMethod) {
...
func (m Quote) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m Quote) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m Quote) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m Quote) GetExDestination() (v string, err quickfix.MessageRejectError) {
...
func (m Quote) GetSettlCurrency() (v string, err quickfix.MessageRejectError) {
...
func (m Quote) GetOrderRestrictions() (v enum.OrderRestrictions, err quickfix.MessageRejectError) {
...
func (m Quote) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m Quote) GetBookingType() (v enum.BookingType, err quickfix.MessageRejectError) {
...
func (m Quote) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m Quote) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m Quote) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m Quote) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m Quote) GetNoRateSources() (NoRateSourcesRepeatingGroup, quickfix.MessageRejectError) {
...
func (m Quote) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m Quote) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m Quote) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m Quote) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m Quote) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m Quote) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m Quote) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m Quote) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m Quote) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m Quote) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m Quote) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m Quote) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m Quote) HasSettlCurrency() bool {
...
func (m Quote) HasOrderRestrictions() bool {
...
func (m Quote) HasBookingType() bool {
...
func (m Quote) HasOptPayoutAmount() bool {
...
func (m Quote) HasValuationMethod() bool {
...
func (m Quote) HasNotionalPercentageOutstanding() bool {
...
func (m Quote) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m Quote) HasStrikePriceDeterminationMethod() bool {
...
func (m Quote) HasStrikePriceBoundaryMethod() bool {
...
func (m Quote) HasStrikePriceBoundaryPrecision() bool {
