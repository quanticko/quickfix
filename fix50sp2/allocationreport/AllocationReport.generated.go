...
func (m AllocationReport) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m AllocationReport) SetValuationMethod(v enum.ValuationMethod) {
...
func (m AllocationReport) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m AllocationReport) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetNoRateSources sets NoRateSources, Tag 1445
func (m AllocationReport) SetNoRateSources(f NoRateSourcesRepeatingGroup) {
	m.SetGroup(f)
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m AllocationReport) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m AllocationReport) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m AllocationReport) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m AllocationReport) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m AllocationReport) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m AllocationReport) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m AllocationReport) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetNoRateSources() (NoRateSourcesRepeatingGroup, quickfix.MessageRejectError) {
...
func (m AllocationReport) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m AllocationReport) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m AllocationReport) HasOptPayoutAmount() bool {
...
func (m AllocationReport) HasValuationMethod() bool {
...
func (m AllocationReport) HasNotionalPercentageOutstanding() bool {
...
func (m AllocationReport) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m AllocationReport) HasStrikePriceDeterminationMethod() bool {
...
func (m AllocationReport) HasStrikePriceBoundaryMethod() bool {
...
func (m AllocationReport) HasStrikePriceBoundaryPrecision() bool {
