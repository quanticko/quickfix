...
func (m DontKnowTrade) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m DontKnowTrade) SetValuationMethod(v enum.ValuationMethod) {
...
func (m DontKnowTrade) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m DontKnowTrade) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m DontKnowTrade) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m DontKnowTrade) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m DontKnowTrade) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m DontKnowTrade) HasOptPayoutAmount() bool {
...
func (m DontKnowTrade) HasValuationMethod() bool {
...
func (m DontKnowTrade) HasNotionalPercentageOutstanding() bool {
...
func (m DontKnowTrade) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m DontKnowTrade) HasStrikePriceDeterminationMethod() bool {
...
func (m DontKnowTrade) HasStrikePriceBoundaryMethod() bool {
...
func (m DontKnowTrade) HasStrikePriceBoundaryPrecision() bool {
