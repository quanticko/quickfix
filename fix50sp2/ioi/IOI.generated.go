...
func (m IOI) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m IOI) SetValuationMethod(v enum.ValuationMethod) {
...
func (m IOI) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m IOI) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m IOI) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m IOI) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m IOI) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m IOI) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m IOI) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m IOI) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m IOI) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m IOI) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m IOI) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m IOI) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m IOI) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m IOI) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m IOI) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m IOI) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m IOI) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m IOI) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m IOI) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m IOI) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m IOI) HasOptPayoutAmount() bool {
...
func (m IOI) HasValuationMethod() bool {
...
func (m IOI) HasNotionalPercentageOutstanding() bool {
...
func (m IOI) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m IOI) HasStrikePriceDeterminationMethod() bool {
...
func (m IOI) HasStrikePriceBoundaryMethod() bool {
...
func (m IOI) HasStrikePriceBoundaryPrecision() bool {
