...
func (m NoQuoteEntries) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m NoQuoteEntries) GetQuoteEntryRejectReason() (v int, err quickfix.MessageRejectError) {
