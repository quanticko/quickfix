...
func (m NoOrders) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m NoOrders) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m NoOrders) SetOptPayoutType(v enum.OptPayoutType) {
...
func (m NoOrders) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m NoOrders) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
