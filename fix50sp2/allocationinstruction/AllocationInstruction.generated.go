...
func (m AllocationInstruction) SetValuationMethod(v enum.ValuationMethod) {
...
func (m AllocationInstruction) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m AllocationInstruction) SetFlowScheduleType(v enum.FlowScheduleType) {
...
func (m AllocationInstruction) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m AllocationInstruction) SetSeniority(v enum.Seniority) {
...
func (m AllocationInstruction) SetStrikePriceDeterminationMethod(v enum.StrikePriceDeterminationMethod) {
	m.Set(field.NewStrikePriceDeterminationMethod(v))
}

//SetStrikePriceBoundaryMethod sets StrikePriceBoundaryMethod, Tag 1479
func (m AllocationInstruction) SetStrikePriceBoundaryMethod(v enum.StrikePriceBoundaryMethod) {
...
func (m AllocationInstruction) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m AllocationInstruction) SetOptPayoutType(v enum.OptPayoutType) {
...
func (m AllocationInstruction) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m AllocationInstruction) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
