...
func (m SecurityStatus) SetHaltReasonInt(v enum.HaltReasonInt) {
...
func (m SecurityStatus) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m SecurityStatus) SetValuationMethod(v enum.ValuationMethod) {
...
func (m SecurityStatus) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m SecurityStatus) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m SecurityStatus) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m SecurityStatus) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m SecurityStatus) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m SecurityStatus) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m SecurityStatus) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m SecurityStatus) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m SecurityStatus) GetHaltReasonInt() (v enum.HaltReasonInt, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m SecurityStatus) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m SecurityStatus) HasHaltReasonInt() bool {
...
func (m SecurityStatus) HasOptPayoutAmount() bool {
...
func (m SecurityStatus) HasValuationMethod() bool {
...
func (m SecurityStatus) HasNotionalPercentageOutstanding() bool {
...
func (m SecurityStatus) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m SecurityStatus) HasStrikePriceDeterminationMethod() bool {
...
func (m SecurityStatus) HasStrikePriceBoundaryMethod() bool {
...
func (m SecurityStatus) HasStrikePriceBoundaryPrecision() bool {
