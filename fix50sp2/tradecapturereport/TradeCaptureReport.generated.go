...
import (
	...
	"github.com/quanticko/quickfix/enum"
	"github.com/quanticko/quickfix/field"
	"github.com/quanticko/quickfix/fixt11"
	"github.com/quanticko/quickfix/tag"
)
...
func (m TradeCaptureReport) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m TradeCaptureReport) SetValuationMethod(v enum.ValuationMethod) {
...
func (m TradeCaptureReport) SetMarketSegmentID(v string) {
	m.Set(field.NewMarketSegmentID(v))
}

//SetMarketID sets MarketID, Tag 1301
func (m TradeCaptureReport) SetMarketID(v string) {
...
//SetVenueType sets VenueType, Tag 1430
func (m TradeCaptureReport) SetVenueType(v enum.VenueType) {
	m.Set(field.NewVenueType(v))
}

//SetContractMultiplierUnit sets ContractMultiplierUnit, Tag 1435
func (m TradeCaptureReport) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m TradeCaptureReport) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m TradeCaptureReport) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m TradeCaptureReport) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m TradeCaptureReport) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m TradeCaptureReport) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m TradeCaptureReport) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m TradeCaptureReport) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m TradeCaptureReport) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetMarketSegmentID() (v string, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetMarketID() (v string, err quickfix.MessageRejectError) {
...
//GetVenueType gets VenueType, Tag 1430
func (m TradeCaptureReport) GetVenueType() (v enum.VenueType, err quickfix.MessageRejectError) {
	var f field.VenueTypeField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m TradeCaptureReport) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m TradeCaptureReport) HasOptPayoutAmount() bool {
...
func (m TradeCaptureReport) HasValuationMethod() bool {
...
func (m TradeCaptureReport) HasMarketSegmentID() bool {
	return m.Has(tag.MarketSegmentID)
}

//HasMarketID returns true if MarketID is present, Tag 1301
func (m TradeCaptureReport) HasMarketID() bool {
...
func (m TradeCaptureReport) HasNotionalPercentageOutstanding() bool {
...
func (m TradeCaptureReport) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m TradeCaptureReport) HasStrikePriceDeterminationMethod() bool {
...
func (m TradeCaptureReport) HasStrikePriceBoundaryMethod() bool {
...
func (m TradeCaptureReport) HasStrikePriceBoundaryPrecision() bool {
...
//SetSideLastQty sets SideLastQty, Tag 1009
func (m NoSides) SetSideLastQty(v int) {
	m.Set(field.NewSideLastQty(v))
}
...
func (m NoSides) SetOrderCategory(v enum.OrderCategory) {
...
func (m NoSides) SetRefOrderID(v string) {
	m.Set(field.NewRefOrderID(v))
}

//SetRefOrderIDSource sets RefOrderIDSource, Tag 1081
func (m NoSides) SetRefOrderIDSource(v enum.RefOrderIDSource) {
	m.Set(field.NewRefOrderIDSource(v))
}

//SetRefOrdIDReason sets RefOrdIDReason, Tag 1431
func (m NoSides) SetRefOrdIDReason(v enum.RefOrdIDReason) {
	m.Set(field.NewRefOrdIDReason(v))
}
...
func (m NoSides) SetPrice(value decimal.Decimal, scale int32) {
	m.Set(field.NewPrice(value, scale))
}

//SetStopPx sets StopPx, Tag 99
func (m NoSides) SetStopPx(value decimal.Decimal, scale int32) {
...
func (m NoSides) SetOrdStatus(v enum.OrdStatus) {
...
//SetOrigCustOrderCapacity sets OrigCustOrderCapacity, Tag 1432
func (m NoSides) SetOrigCustOrderCapacity(v enum.OrigCustOrderCapacity) {
	m.Set(field.NewOrigCustOrderCapacity(v))
}
...
//SetSideExecID sets SideExecID, Tag 1427
func (m NoSides) SetSideExecID(v string) {
	m.Set(field.NewSideExecID(v))
}

//SetOrderDelay sets OrderDelay, Tag 1428
func (m NoSides) SetOrderDelay(v int) {
	m.Set(field.NewOrderDelay(v))
}

//SetOrderDelayUnit sets OrderDelayUnit, Tag 1429
func (m NoSides) SetOrderDelayUnit(v enum.OrderDelayUnit) {
	m.Set(field.NewOrderDelayUnit(v))
}

//SetSideLiquidityInd sets SideLiquidityInd, Tag 1444
func (m NoSides) SetSideLiquidityInd(v int) {
	m.Set(field.NewSideLiquidityInd(v))
}
...
//GetSideLastQty gets SideLastQty, Tag 1009
func (m NoSides) GetSideLastQty() (v int, err quickfix.MessageRejectError) {
	var f field.SideLastQtyField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m NoSides) GetSideTrdSubTyp() (v int, err quickfix.MessageRejectError) {
...
func (m NoSides) GetOrderCategory() (v enum.OrderCategory, err quickfix.MessageRejectError) {
...
func (m NoSides) GetRefOrderID() (v string, err quickfix.MessageRejectError) {
...
func (m NoSides) GetRefOrderIDSource() (v enum.RefOrderIDSource, err quickfix.MessageRejectError) {
...
//GetRefOrdIDReason gets RefOrdIDReason, Tag 1431
func (m NoSides) GetRefOrdIDReason() (v enum.RefOrdIDReason, err quickfix.MessageRejectError) {
	var f field.RefOrdIDReasonField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m NoSides) GetPrice() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetStopPx() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetOrdStatus() (v enum.OrdStatus, err quickfix.MessageRejectError) {
...
func (m NoSides) GetLeavesQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetCumQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetTimeInForce() (v enum.TimeInForce, err quickfix.MessageRejectError) {
...
func (m NoSides) GetExpireTime() (v time.Time, err quickfix.MessageRejectError) {
...
func (m NoSides) GetSecondaryDisplayQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetDisplayWhen() (v enum.DisplayWhen, err quickfix.MessageRejectError) {
...
func (m NoSides) GetDisplayMethod() (v enum.DisplayMethod, err quickfix.MessageRejectError) {
...
func (m NoSides) GetDisplayLowQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetDisplayHighQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetDisplayMinIncr() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetRefreshQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m NoSides) GetDisplayQty() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
//GetOrigCustOrderCapacity gets OrigCustOrderCapacity, Tag 1432
func (m NoSides) GetOrigCustOrderCapacity() (v enum.OrigCustOrderCapacity, err quickfix.MessageRejectError) {
	var f field.OrigCustOrderCapacityField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
//GetSideExecID gets SideExecID, Tag 1427
func (m NoSides) GetSideExecID() (v string, err quickfix.MessageRejectError) {
	var f field.SideExecIDField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
//GetOrderDelay gets OrderDelay, Tag 1428
func (m NoSides) GetOrderDelay() (v int, err quickfix.MessageRejectError) {
	var f field.OrderDelayField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
//GetOrderDelayUnit gets OrderDelayUnit, Tag 1429
func (m NoSides) GetOrderDelayUnit() (v enum.OrderDelayUnit, err quickfix.MessageRejectError) {
	var f field.OrderDelayUnitField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
//GetSideLiquidityInd gets SideLiquidityInd, Tag 1444
func (m NoSides) GetSideLiquidityInd() (v int, err quickfix.MessageRejectError) {
	var f field.SideLiquidityIndField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
//HasSideLastQty returns true if SideLastQty is present, Tag 1009
func (m NoSides) HasSideLastQty() bool {
	return m.Has(tag.SideLastQty)
}
...
func (m NoSides) HasOrderCategory() bool {
...
func (m NoSides) HasRefOrderID() bool {
	return m.Has(tag.RefOrderID)
}

//HasRefOrderIDSource returns true if RefOrderIDSource is present, Tag 1081
func (m NoSides) HasRefOrderIDSource() bool {
	return m.Has(tag.RefOrderIDSource)
}

//HasRefOrdIDReason returns true if RefOrdIDReason is present, Tag 1431
func (m NoSides) HasRefOrdIDReason() bool {
	return m.Has(tag.RefOrdIDReason)
}
...
func (m NoSides) HasPrice() bool {
	return m.Has(tag.Price)
}

//HasStopPx returns true if StopPx is present, Tag 99
func (m NoSides) HasStopPx() bool {
...
func (m NoSides) HasOrdStatus() bool {
...
//HasOrigCustOrderCapacity returns true if OrigCustOrderCapacity is present, Tag 1432
func (m NoSides) HasOrigCustOrderCapacity() bool {
	return m.Has(tag.OrigCustOrderCapacity)
}
...
//HasSideExecID returns true if SideExecID is present, Tag 1427
func (m NoSides) HasSideExecID() bool {
	return m.Has(tag.SideExecID)
}

//HasOrderDelay returns true if OrderDelay is present, Tag 1428
func (m NoSides) HasOrderDelay() bool {
	return m.Has(tag.OrderDelay)
}

//HasOrderDelayUnit returns true if OrderDelayUnit is present, Tag 1429
func (m NoSides) HasOrderDelayUnit() bool {
	return m.Has(tag.OrderDelayUnit)
}

//HasSideLiquidityInd returns true if SideLiquidityInd is present, Tag 1444
func (m NoSides) HasSideLiquidityInd() bool {
	return m.Has(tag.SideLiquidityInd)
}
