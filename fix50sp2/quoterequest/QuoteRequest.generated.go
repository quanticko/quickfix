...
func (m QuoteRequest) SetOrderRestrictions(v enum.OrderRestrictions) {
...
func (m QuoteRequest) SetBookingType(v enum.BookingType) {
...
func (m QuoteRequest) GetOrderRestrictions() (v enum.OrderRestrictions, err quickfix.MessageRejectError) {
...
func (m QuoteRequest) GetBookingType() (v enum.BookingType, err quickfix.MessageRejectError) {
...
func (m QuoteRequest) HasOrderRestrictions() bool {
...
func (m QuoteRequest) HasBookingType() bool {
...
func (m NoRelatedSym) SetNoRateSources(f NoRateSourcesRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m NoRelatedSym) GetNoRateSources() (NoRateSourcesRepeatingGroup, quickfix.MessageRejectError) {
...
func (m NoRelatedSym) HasNoRateSources() bool {
