...
func (m PositionReport) SetInstrRegistry(v string) {
...
func (m PositionReport) SetPriceDelta(value decimal.Decimal, scale int32) {
...
func (m PositionReport) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m PositionReport) SetValuationMethod(v enum.ValuationMethod) {
...
//SetModelType sets ModelType, Tag 1434
func (m PositionReport) SetModelType(v enum.ModelType) {
	m.Set(field.NewModelType(v))
}

//SetContractMultiplierUnit sets ContractMultiplierUnit, Tag 1435
func (m PositionReport) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m PositionReport) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m PositionReport) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m PositionReport) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m PositionReport) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m PositionReport) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m PositionReport) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m PositionReport) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m PositionReport) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetPriceDelta() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
//GetModelType gets ModelType, Tag 1434
func (m PositionReport) GetModelType() (v enum.ModelType, err quickfix.MessageRejectError) {
	var f field.ModelTypeField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m PositionReport) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m PositionReport) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m PositionReport) HasPriceDelta() bool {
...
func (m PositionReport) HasOptPayoutAmount() bool {
...
func (m PositionReport) HasValuationMethod() bool {
...
func (m PositionReport) HasNotionalPercentageOutstanding() bool {
...
func (m PositionReport) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m PositionReport) HasStrikePriceDeterminationMethod() bool {
...
func (m PositionReport) HasStrikePriceBoundaryMethod() bool {
...
func (m PositionReport) HasStrikePriceBoundaryPrecision() bool {
