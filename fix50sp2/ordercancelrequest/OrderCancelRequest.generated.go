...
func (m OrderCancelRequest) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m OrderCancelRequest) SetValuationMethod(v enum.ValuationMethod) {
...
func (m OrderCancelRequest) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m OrderCancelRequest) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m OrderCancelRequest) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m OrderCancelRequest) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m OrderCancelRequest) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m OrderCancelRequest) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m OrderCancelRequest) SetOptPayoutType(v enum.OptPayoutType) {
