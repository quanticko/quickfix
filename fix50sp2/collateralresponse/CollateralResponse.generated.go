...
func (m CollateralResponse) SetInstrRegistry(v string) {
...
func (m CollateralResponse) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m CollateralResponse) SetValuationMethod(v enum.ValuationMethod) {
...
func (m CollateralResponse) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m CollateralResponse) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m CollateralResponse) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m CollateralResponse) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m CollateralResponse) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m CollateralResponse) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m CollateralResponse) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m CollateralResponse) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m CollateralResponse) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m CollateralResponse) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m CollateralResponse) HasOptPayoutAmount() bool {
...
func (m CollateralResponse) HasValuationMethod() bool {
...
func (m CollateralResponse) HasNotionalPercentageOutstanding() bool {
...
func (m CollateralResponse) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m CollateralResponse) HasStrikePriceDeterminationMethod() bool {
...
func (m CollateralResponse) HasStrikePriceBoundaryMethod() bool {
...
func (m CollateralResponse) HasStrikePriceBoundaryPrecision() bool {
