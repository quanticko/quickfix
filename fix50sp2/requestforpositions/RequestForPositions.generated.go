...
func (m RequestForPositions) SetInstrRegistry(v string) {
...
func (m RequestForPositions) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m RequestForPositions) SetValuationMethod(v enum.ValuationMethod) {
...
func (m RequestForPositions) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m RequestForPositions) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m RequestForPositions) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m RequestForPositions) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m RequestForPositions) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m RequestForPositions) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m RequestForPositions) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m RequestForPositions) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m RequestForPositions) GetInstrRegistry() (v string, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m RequestForPositions) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m RequestForPositions) HasOptPayoutAmount() bool {
...
func (m RequestForPositions) HasValuationMethod() bool {
...
func (m RequestForPositions) HasNotionalPercentageOutstanding() bool {
...
func (m RequestForPositions) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m RequestForPositions) HasStrikePriceDeterminationMethod() bool {
...
func (m RequestForPositions) HasStrikePriceBoundaryMethod() bool {
...
func (m RequestForPositions) HasStrikePriceBoundaryPrecision() bool {
