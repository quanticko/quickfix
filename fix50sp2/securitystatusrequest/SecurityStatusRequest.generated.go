...
func (m SecurityStatusRequest) SetOptPayoutAmount(value decimal.Decimal, scale int32) {
...
func (m SecurityStatusRequest) SetValuationMethod(v enum.ValuationMethod) {
...
func (m SecurityStatusRequest) SetContractMultiplierUnit(v enum.ContractMultiplierUnit) {
	m.Set(field.NewContractMultiplierUnit(v))
}

//SetFlowScheduleType sets FlowScheduleType, Tag 1439
func (m SecurityStatusRequest) SetFlowScheduleType(v enum.FlowScheduleType) {
	m.Set(field.NewFlowScheduleType(v))
}

//SetRestructuringType sets RestructuringType, Tag 1449
func (m SecurityStatusRequest) SetRestructuringType(v enum.RestructuringType) {
	m.Set(field.NewRestructuringType(v))
}

//SetSeniority sets Seniority, Tag 1450
func (m SecurityStatusRequest) SetSeniority(v enum.Seniority) {
	m.Set(field.NewSeniority(v))
}

//SetNotionalPercentageOutstanding sets NotionalPercentageOutstanding, Tag 1451
func (m SecurityStatusRequest) SetNotionalPercentageOutstanding(value decimal.Decimal, scale int32) {
...
func (m SecurityStatusRequest) SetUnderlyingPriceDeterminationMethod(v enum.UnderlyingPriceDeterminationMethod) {
	m.Set(field.NewUnderlyingPriceDeterminationMethod(v))
}

//SetOptPayoutType sets OptPayoutType, Tag 1482
func (m SecurityStatusRequest) SetOptPayoutType(v enum.OptPayoutType) {
	m.Set(field.NewOptPayoutType(v))
}

//SetNoComplexEvents sets NoComplexEvents, Tag 1483
func (m SecurityStatusRequest) SetNoComplexEvents(f NoComplexEventsRepeatingGroup) {
	m.SetGroup(f)
}
...
func (m SecurityStatusRequest) GetOptPayoutAmount() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetValuationMethod() (v enum.ValuationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetContractMultiplierUnit() (v enum.ContractMultiplierUnit, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetFlowScheduleType() (v enum.FlowScheduleType, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetRestructuringType() (v enum.RestructuringType, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetSeniority() (v enum.Seniority, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetOriginalNotionalPercentageOutstanding() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetAttachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetDetachmentPoint() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetStrikePriceDeterminationMethod() (v enum.StrikePriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetStrikePriceBoundaryMethod() (v enum.StrikePriceBoundaryMethod, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetStrikePriceBoundaryPrecision() (v decimal.Decimal, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetUnderlyingPriceDeterminationMethod() (v enum.UnderlyingPriceDeterminationMethod, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetOptPayoutType() (v enum.OptPayoutType, err quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) GetNoComplexEvents() (NoComplexEventsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m SecurityStatusRequest) HasOptPayoutAmount() bool {
...
func (m SecurityStatusRequest) HasValuationMethod() bool {
...
func (m SecurityStatusRequest) HasNotionalPercentageOutstanding() bool {
...
func (m SecurityStatusRequest) HasOriginalNotionalPercentageOutstanding() bool {
...
func (m SecurityStatusRequest) HasAttachmentPoint() bool {
	return m.Has(tag.AttachmentPoint)
}

//HasDetachmentPoint returns true if DetachmentPoint is present, Tag 1458
func (m SecurityStatusRequest) HasDetachmentPoint() bool {
...
func (m SecurityStatusRequest) HasStrikePriceDeterminationMethod() bool {
...
func (m SecurityStatusRequest) HasStrikePriceBoundaryMethod() bool {
...
func (m SecurityStatusRequest) HasStrikePriceBoundaryPrecision() bool {
